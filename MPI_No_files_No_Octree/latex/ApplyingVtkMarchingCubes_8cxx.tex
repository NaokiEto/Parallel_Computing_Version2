...
\-This program converts a vtk\-Poly\-Data image into volume representation (vtk\-Image\-Data) where the foreground voxels are 1 and the background voxels are 0. \-Internally vtk\-Poly\-Data\-To\-Image\-Stencil is utilized as as \-M\-P\-I. \-The resultant image is saved to disk in metaimage file formats. vtk\-Marching\-Cubes is applied to these file formats, which are then conglomerated by the master process, and an output vtk file is outputted. \hypertarget{ApplyingVtkMarchingCubes_8cxx_abf4d3375ca506ee4e183fad5ff828be2}{\index{\-Applying\-Vtk\-Marching\-Cubes.\-cxx@{\-Applying\-Vtk\-Marching\-Cubes.\-cxx}!search@{search}}
