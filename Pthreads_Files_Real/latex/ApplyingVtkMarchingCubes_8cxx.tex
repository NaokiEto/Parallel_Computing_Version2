...
\-This program converts a vtk\-Poly\-Data image into volume representation (vtk\-Image\-Data) where the foreground voxels are 1 and the background voxels are 0. \-Internally vtk\-Poly\-Data\-To\-Image\-Stencil is utilized as well as pthreads. \-The resultant image is saved to disk in metaimage file formats. vtk\-Marching\-Cubes is applied to these file formats, and temporary vtk files are outputted. 